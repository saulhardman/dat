...
<section class="<?php echo $pageName; ?>">
    ...
    <div class="content container">
        ...
        <div class="intro">
            ...
            <p><strong>The evolution of digital technologies and their applications, such as ‘Social Media’, the ‘Internet of Things’, augmented reality, virtual worlds, wearable and physical computing is explored in all the creative, design and production aspects.</strong> We utilise the latest software and teaching approaches:</p>
